...
# Step 1: Sort the DataFrame by the 'timestamps' column in ascending order
data1_sorted = data1.sort_values(by='timestamps', ascending=True)
# print(data1_sorted[0:100])
'''
...
for step in range(4): # data from first 2000ms, take 400ms for each loop
    ...
    ax = fig.add_subplot(2,2,step+1, projection='3d')
